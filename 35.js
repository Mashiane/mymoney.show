...
MaintainCategories.innerHTML=[  NSB.FooterBar_jqm('maintainCategoriesMenu', 'Add,Save,Delete', '12', 'helvetica', 'normal', 'normal', 'b', 'plus,check,minus', 'left', '0', ' '),
  NSB.HeaderBar_jqm("maintainCategoriesTitle", "Maintain Category", "Back", "arrow-l", "", "false", " data-theme=b style='' class=' ' "),
  ...
  "<div id='txtAddCategoryName_wrapper'><input id='txtAddCategoryName' type='text' data-theme='b' name='' autocorrect='on' autocomplete='on' autocapitalize='on' maxlength='32' value='' placeholder='Enter category here' data-mini='true' data-nsb-type='TextBox_jqm' class=' ' /></div>",
  ].join('');
